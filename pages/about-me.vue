<template>
  <main v-if="!loading" id="about-me" class="page">
    ...
    <div id="page-menu" class="w-full flex">
      ...
      <div id="sections">
        <div id="section-icon" v-for="section in config.about.sections" :key="section.title"
      ...
      <div id="section-content" class="hidden lg:block w-full h-full border-right">
        ...
        <!-- folders -->
        <div>
          <div v-for="(folder, key, index) in config.about.sections[currentSection]?.info" :key="key"
        ...
        <div id="contact-sources" class="hidden lg:w-full lg:h-full lg:flex lg:flex-col my-4">
          <div class="flex align-center flex-col items-stretch mb-2 ml-2 gap-3">
            <!-- mail -->
            <div class="flex gap-2 text-[#85A5C4] items-center">

              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#85A5C4" class="bi bi-envelope-at-fill"
                viewBox="0 0 16 16">
                <path
              ...
              <a href="mailto:LlamasScripters@gmail.com">LlamasScripters@gmail.com</a>

            </div>

            <div class="flex gap-2 text-[#85A5C4] align-center items-stretch">
              <!-- Telephone -->
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#85A5C4" class="bi bi-telephone-fill"
                viewBox="0 0 16 16">
      ...
      <div id="section-content" class="lg:hidden w-full font-fira_regular">
        ...
        <div v-for="section in config.about.sections" :key="section.title">
          ...
          <div :id="'folders-' + section.title" class="hidden">
            ...
            <div v-for="(folder, key, index) in config.about.sections[section.title]?.info" :key="key"
